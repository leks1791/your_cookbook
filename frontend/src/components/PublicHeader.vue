  ...
  <header class="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
    <div class="container mx-auto px-4 h-16 flex items-center justify-between gap-4">
      ...
      <nav class="flex items-center gap-4">
        <router-link to="/about" class="hidden md:block text-sm font-medium text-stone-600 hover:text-orange-500 transition-colors">
          О проекте
        </router-link>
        <router-link to="/catalog" class="hidden md:block text-sm font-medium text-stone-600 hover:text-orange-500 transition-colors">
          Каталог
        </router-link>
